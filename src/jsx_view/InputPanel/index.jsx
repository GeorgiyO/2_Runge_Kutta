...
export class InputPanel extends React.Component {
    ...
    render() {
        ...
        let {foo, realFoo, x0, y0, h, iterations, rk4} = this.state[mode];
        ...
        return (
            <div className="InputPanel">
                ...
                <p>Использовать метод Рунге-Кутта 4й степени точности</p>
                <input type="checkbox" checked={rk4} onChange={_.onRk4Change}/>
